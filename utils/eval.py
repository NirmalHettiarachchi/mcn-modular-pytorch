"""
Code to evaluate results on the DiDeMo dataset.
"""
...
def eval_predictions(segments, data):
    """
    Inputs:
    segments: For each item in the ground truth data, rank possible video segments
      given the description and video.
