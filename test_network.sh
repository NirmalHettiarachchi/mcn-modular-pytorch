...
python test_network.py --deploy_net "prototxts/deploy_clip_retrieval_${RGB_TAG}.json" \
...
python test_network.py --deploy_net "prototxts/deploy_clip_retrieval_${FLOW_TAG}.json" \
...
python late_fusion.py --rgb_tag "${RGB_TAG}" \
                      --flow_tag "${FLOW_TAG}" \
                      --split val \
                      --iter "${ITER}"
